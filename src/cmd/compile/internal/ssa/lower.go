...
func checkLower(f *Func) {
	...
	for _, b := range f.Blocks {
		for _, v := range b.Values {
			...
			switch v.Op {
			case OpSP, OpSB, OpInitMem, OpArg, OpArgIntReg, OpArgFloatReg, OpPhi, OpVarDef, OpVarKill, OpVarLive, OpKeepAlive, OpSelect0, OpSelect1, OpSelectN, OpConvert, OpInlMark, OpHardwiredZero:
